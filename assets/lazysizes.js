 ...
 function f(a, b) {
  var d,
   ...
   i = function () {
    ...
    b &&
     e !== b &&
     ((e = b), (h.backgroundImage = 'url(' + (m.test(b) ? JSON.stringify(b) : b) + ')'), d || ((d = !0), c.rC(g, f.loadingClass), c.aC(g, f.loadedClass)));
   },
   j = function () {
    c.rAF(i);
   };
  ...
  addEventListener(
   ...
   function (a) {
    if (a.detail.instance == c) {
     ...
     if (
      ((b = a.target), a.detail.dataAttr && !a.defaultPrevented && !j.disabled && (q = b.getAttribute(i.sizesAttr) || b.getAttribute('sizes')) && r.test(q))
     ) {
   ...
   i = {
    getParent: function (b, c) {
     ...
     return (
      ...
      'self' != c &&
       (d = 'prev' == c ? b.previousElementSibling : c && (e.closest || a.jQuery) ? (e.closest ? e.closest(c) : jQuery(e).closest(c)[0]) || e : e),
      d
     );
    },
    getFit: function (a) {
     ...
     for (c = 0; c < m.length; c++)
      if (
       ...
       (h = parseFloat(b.getAttribute('data-aspectratio'))),
        h ||
         ((i = e.match(d)),
         i ? ('w' == i[2] ? ((j = i[1]), (k = i[3])) : ((j = i[3]), (k = i[1]))) : ((j = b.getAttribute('width')), (k = b.getAttribute('height'))),
         (h = j / k));
       break;
      }
     return h;
    ...
    c._lazybgset && c._lazybgset.parentNode == c && c.removeChild(c._lazybgset),
     ...
     a.forEach(function (a) {
      ...
      i && 'auto' != i && d.setAttribute('sizes', i),
       (c = a.match(f)) ? (d.setAttribute(lazySizesConfig.srcsetAttr, c[1]), l(d, c[2]), l(d, c[3])) : d.setAttribute(lazySizesConfig.srcsetAttr, a),
       h.appendChild(d);
     }),
