...
!(function (e, t) {
 ...
 const J = [
  function ({ swiper: e, extendParams: t, on: s }) {
   ...
   t({
    virtual: { enabled: !1, slides: [], cache: !0, renderSlide: null, renderExternal: null, renderExternalUpdate: !0, addSlidesBefore: 0, addSlidesAfter: 0 },
   }),
  ...
  function ({ swiper: e, extendParams: t, on: s, emit: i }) {
   ...
   (e.autoplay = { running: !1, paused: !1 }),
    t({
     autoplay: { enabled: !1, delay: 3e3, waitForTransition: !0, disableOnInteraction: !0, stopOnLastSlide: !1, reverseDirection: !1, pauseOnMouseEnter: !1 },
    }),
    s('init', () => {
   ...
   t({ grid: { rows: 1, fill: 'column' } }),
    (e.grid = {
     ...
     updateWrapperSize: (t, a, i) => {
      ...
      if (
       ((e.virtualSize = (t + r) * s), (e.virtualSize = Math.ceil(e.virtualSize / o) - r), e.$wrapperEl.css({ [i('width')]: `${e.virtualSize + r}px` }), n)
      ) {
       a.splice(0, a.length);
       const t = [];
     ...
     setTranslate: () => {
      ...
      for (let i = 0; i < t.length; i += 1) {
       ...
       let o = -180 * n,
        ...
        p = 0;
       if (
        (e.isHorizontal() ? s && (o = -o) : ((p = c), (c = 0), (d = -o), (o = 0)), (r[0].style.zIndex = -Math.abs(Math.round(n)) + t.length), a.slideShadows)
       ) {
